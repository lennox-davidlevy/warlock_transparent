...
let colors_name = "warlock_transparent"

if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")

    " Transparent
    " hi Normal ctermbg=235 ctermfg=250 cterm=NONE guibg=NONE guifg=#9e8e78 gui=NONE
    " hi LineNr ctermbg=234 ctermfg=242 cterm=NONE guibg=NONE guifg=#6c6c6c gui=NONE
    " hi SignColumn ctermbg=234 ctermfg=242 cterm=NONE guibg=NONE guifg=#6c6c6c gui=NONE
    " hi DiagnosticSignError ctermbg=238 ctermfg=250 cterm=NONE guibg=NONE guifg=#fb4934 gui=NONE
    " hi DiagnosticSignWarn ctermbg=238 ctermfg=250 cterm=NONE guibg=NONE guifg=#fe8019 gui=NONE
    " hi DiagnosticSignHint ctermbg=238 ctermfg=250 cterm=NONE guibg=NONE guifg=#83a598 gui=NONE
    " hi DiagnosticSignInfo ctermbg=238 ctermfg=250 cterm=NONE guibg=NONE guifg=#fabd2f gui=NONE
    ...
    " hi Pmenu ctermbg=238 ctermfg=250 cterm=NONE guibg=NONE guifg=#bcbcbc gui=NONE
    ...
    hi DiagnosticSignWarn ctermbg=238 ctermfg=250 cterm=NONE guibg=#262626 guifg=#fe8019 gui=NONE
    hi DiagnosticSignHint ctermbg=238 ctermfg=250 cterm=NONE guibg=#262626 guifg=#83a598 gui=NONE
    hi DiagnosticSignInfo ctermbg=238 ctermfg=250 cterm=NONE guibg=#262626 guifg=#fabd2f gui=NONE
    hi GitGutterAdd guifg=#b8bb26 guibg=#262626 gui=NONE cterm=NONE
    hi GitGutterChange guifg=#8ec07c guibg=#262626 gui=NONE cterm=NONE
    hi GitGutterDelete guifg=#fb4934 guibg=#262626 gui=NONE cterm=NONE
    hi GitGutterChangeDelete guifg=#8ec07c guibg=#262626 gui=NONE cterm=NONE
    ...
    hi EndOfBuffer ctermbg=NONE ctermfg=240 cterm=NONE guibg=NONE guifg=#262626 gui=NONE
    hi TelescopeSelection guifg=#000000 guibg=#ffb000
